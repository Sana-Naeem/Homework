...
public interface University extends College {
	 ...
	 * class? 
	 * Answer: Yes, an Interface can inherit another Interface. However, an
	 ...
	 * questions (by multiple line comments). 
	 * Answer: An interface can inherit more
	 * than one interface. For example: public interface University extends College, Hospital{
	 * 
	 ...
	 * interface? 
	 * Answer: Yes, an Abstract class Can inherit other Abstract Class or
	 * a Regular class or Interface.
	 * 
	 * How many inheritances is possible by an Abstract Class? Use the all of above
	 * Abstract Classes and use the keywords to answer my questions. 
	 * Answer: An Abstract class Can inherit either Only ONE abstract class or Only ONE regular
	 ...
	 * interface? 
	 * Answer: Yes, a Regular class Can inherit other Abstract Class or a
	 * Regular class or Interface.
	 * 
	 * How many inheritances is possible by a regular Class? Use the all of above
	 * regular Classes and use the keywords to answer my questions. 
	 * Answer: A Regular class Can inherit either Only ONE regular class or Only ONE abstract
	 * class by using the extends keyword. In addition to that, an abstract class
	 * can also inherit One or More interface(s) by using the keyword 'implements'.
	 * 
	 */
