...
/**
	...
	Answer: Only ONE keyword is used for the inheritance in Interface which is "extends" keyword. 
	
	Can an interface inherit other Interface, or a regular class or abstract class? 
	Answer: Yes, an Interface can inherit another Interface. However, an interface CANNOT inherit a regular class or abstract 
	class.
	
	How many inheritance is possible? Use the Interface "University" to answer my questions (by multiple line comments). 
	Answer: An interface can inherit more than one interface. For example: public interface University extends College, Hospital{
	...
	Answer: In Java while using inheritance for an Abstract class we can use Two keywords specifically: "extends (or) 				  	
	implements".
	
	Can an Abstract Class inherit other Abstract Class or a regular class or interface? 
	Answer: Yes, an Abstract class Can inherit other Abstract Class or a Regular class or Interface.
	...
	Answer: An Abstract class Can inherit either Only ONE abstract class or Only ONE regular class by using the extends keyword. 	In addition to that, an abstract class can also inherit One or More interface(s) by using the keyword 'implements'.
	...
	Answer: In Java while using inheritance for a Regular class we can use Two keywords specifically: "extends (or) implements".
	
	Can an regular Class inherit other Abstract Class or a regular class or interface? 
	Answer: Yes, a Regular class Can inherit other Abstract Class or a Regular class or Interface.
	...
	Answer: A Regular class Can inherit either Only ONE regular class or Only ONE abstract class by using the extends keyword. 		In addition to that, an abstract class can also inherit One or More interface(s) by using the keyword 'implements'.
