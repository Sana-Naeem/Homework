...
public class TestPhone {
	...
	public static void main(String[] args) {
		...
		iphone1.message();
		iphone1.camera();
		Phone.battery(); //Here the static method is called by the class in which it is present namely Phone Class.
		...
		System.out.println(iphone1.getInfo() + iphone1.getPrice() + ", user's sex is: " + iphone1.getUser() + ", made in USA: " + 		iphone1.isMadeInUSA());
		 ...
		 * Comment out at the end of TestPhone to inform me which is hierarchical inheritance, multilevel inheritance, and single 				inheritance.
		 	As Iphone 2 and Iphone 3 are both subclasses which are inherited by one common parent class so they show a 						Hierarchical inheritance.
		 	Iphone 4, Iphone 5 and Iphone 6 show single inheritance.
		 */
